...
BSTIterator.prototype.hasNext = function() {
  console.log('----hasNext----', this.numList.length > 0)
  return this.numList.length > 0
};
...
const t2 = new TreeNode(1, null, null);
const t1 = new TreeNode(2, null, null);
